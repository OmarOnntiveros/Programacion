            ...
            <table class="table table-bordered table-hover">
                <thead class="table-primary">
                    <tr>
                        ...
                        <th><i class="fa fa-trophy" aria-hidden="true"></i>Año</th>
                        <th><i class="fa fa-trophy" aria-hidden="true"></i>Carrera</th>
                        <th><i class="fa fa-trophy" aria-hidden="true"></i>Acción</th>
                    </tr>
                </thead>
                <tbody class="table-light">
                    ...
                    ?>
                        ...
                        <td>
                            <?php echo '<a href="InformacionProfesor.php?dni=' . $res[0] . '">Más Info</a>'?>
                        </td>
                    <?php } ?>
                    </tr>
                </tbody>
